// Vendored from node_modules/uqr/dist/index.mjs (uqr 0.1.3, MIT, github.com/unjs/uqr).
// Serves the /r setup page's client-side QR so the card never leaves the URL fragment.
